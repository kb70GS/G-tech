    ...
    private ResponseBean executeDBAccess(final ExecuteCase eCase, final List<EmployeeBean> pEmployeeBeanList) throws MVCException {
        ...
        try {
            ...
            while (super.resultSet.next()) {
                ...
                employeeBean.setEmpId(resultSet.getString("empId"));
                employeeBean.setPassword(resultSet.getString("password"));
                employeeBean.setName(resultSet.getString("name"));
                employeeBean.setMail(resultSet.getString("mail"));
                employeeBean.setProgramingLanguage(resultSet.getString("programinglanguage"));
                employeeBean.setComment(resultSet.getString("comment"));
    ...
    private void executeSelectQuery(final ExecuteCase eCase, final List<EmployeeBean> pEmployeeBeanList)
        ...
        try {
            ...
            case FIND_BY_EMPID:
                ...
                for (EmployeeBean bean : pEmployeeBeanList) {
                    emp = bean;
                    break;
                }
